...
public class ImageToPdfFragment extends Fragment implements
    ...
    public static String pdfname="Your Pdf Name is";
...
String mob;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mob=MainActivity.mob;
        Log.d("fregVal",name+mob);
         filename = name + "_"+ mob;

        Toast.makeText(mActivity, name+"_"+mob, Toast.LENGTH_SHORT).show();
...
//                final String filename = input.toString();
                Toast.makeText(mActivity, filename, Toast.LENGTH_SHORT).show();
